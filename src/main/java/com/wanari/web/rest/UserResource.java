package com.wanari.web.rest;

import com.codahale.metrics.annotation.Timed;
import com.wanari.domain.Authority;
import com.wanari.domain.User;
import com.wanari.repository.AuthorityRepository;
import com.wanari.repository.UserRepository;
import com.wanari.security.AuthoritiesConstants;
import com.wanari.service.MailService;
import com.wanari.service.UserService;
import com.wanari.web.rest.dto.ManagedUserDTO;
import com.wanari.web.rest.dto.UserDTO;
import com.wanari.web.rest.util.HeaderUtil;
import com.wanari.web.rest.util.PaginationUtil;
...
public class UserResource {
    ...
    @RequestMapping(value = "/maybebug",
        method = RequestMethod.POST,
        produces = MediaType.APPLICATION_JSON_VALUE)
    @Timed
    public ResponseEntity createUserTask(@RequestPart("form") String form, @RequestPart("file") MultipartFile file) {
        return null;
    }
}
